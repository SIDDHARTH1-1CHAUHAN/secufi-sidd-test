  ...
  return (
    <AppScreen>
      <HeroCard>
        ...
        <Text style={[styles.headline, { color: theme.colors.text }]}>See how people, assets, liabilities, and evidence connect.</Text>
        ...
        <View style={styles.row}>
          ...
          <SecondaryCTA label="What the agent sees" onPress={() => setOverlayMode(overlayMode === 'gaps' ? 'relationship' : 'gaps')} />
        </View>
      </HeroCard>
        ...
        <View style={styles.graphCard}>
          ...
          {graph.clusters.map((cluster, index) => (
            <Pressable
              ...
              <Text style={[styles.clusterCount, { color: theme.colors.textMuted }]}>{cluster.count} connected</Text>
            </Pressable>
          ))}
        </View>
      </ContentCard>
...
const styles = StyleSheet.create({
  ...
  headline: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 32, lineHeight: 34 },
  body: { fontFamily: 'Manrope_500Medium', fontSize: 14, lineHeight: 22 },
  graphCard: { height: 320, justifyContent: 'center', alignItems: 'center' },
  householdCore: { width: 132, height: 132, borderRadius: 66, borderWidth: 1, alignItems: 'center', justifyContent: 'center', gap: 4 },
  coreTitle: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 26 },
  coreSub: { fontFamily: 'Manrope_500Medium', fontSize: 11 },
  clusterBubble: { position: 'absolute', width: 118, minHeight: 68, borderRadius: 22, borderWidth: 1, padding: 12, justifyContent: 'center', gap: 2 },
  clusterTitle: { fontFamily: 'Manrope_700Bold', fontSize: 13 },
  clusterCount: { fontFamily: 'Manrope_500Medium', fontSize: 11 },
  personRail: { gap: 10 },
  personChip: { borderWidth: 1, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 12, width: 164, gap: 2 },
  personName: { fontFamily: 'Manrope_700Bold', fontSize: 14 },
  personRole: { fontFamily: 'Manrope_500Medium', fontSize: 12 },
  focusWrap: { gap: 12 },
  focusAnchor: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 28 },
  ...
  overlayTitle: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 24 },
  sheetBlock: { gap: 14 },
});
